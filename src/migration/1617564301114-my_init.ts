...
export class myInit1617564301114 implements MigrationInterface {
  name = 'myInit1617564301114';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      ...
      "description" character varying(300) NOT NULL, CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id"))`,
    );
  }
